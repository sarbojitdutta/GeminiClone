...
export default function MessageInput({ onSend, onOpenSettings }: MessageInputProps) {
    ...
    return (
        <div className="fixed  bottom-0 left-0 right-0 flex flex-col max-w-4xl  mx-auto w-full">
            <div className="flex items-center border border-black/10 p-3 mx-4 rounded-t-3xl bg-white shadow-md transition-all duration-200">
